...
import { PREMIUM_THEMES, THEME_CHOICES, getThemeChoice, setThemeChoice, subscribeThemeChoice, type ThemeChoice } from "@/lib/theme";
...
export function ThemePicker({ className = "", unlockHref }: { className?: string; unlockHref?: string }) {
  ...
  return (
    <div role="radiogroup" aria-label="Theme" className={`flex flex-col gap-2 ${className}`}>
